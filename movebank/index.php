...
<?php 
$url='https://www.movebank.org/movebank/service/json-auth?study_id=657640587&individual_local_identifiers[]=craneTBD24&&max_events_per_individual=10000&timestamp_start=1550624400000&sensor_type=gps';
...
echo "var data = " . $data . ";\n";
echo "console.log(" . file_get_contents($url, false, $context) .");";
 ?>
</script>
        <script type="text/javascript">
            var colors = ['#FFFF00']; 
        ...
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxOi9hp-PZWYMdiFN2tg66HBlZNfyIJgg&v=3.exp&sensor=false&libraries=visualization,geometry"></script>
        <script type="text/javascript">
            var data;
